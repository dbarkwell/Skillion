    ...
    public class RouteDataServiceTests
    {
        public class TryGetRoute
        {
            ...
            public void IntentRequestHasRoute_ReturnsTrue()
            {
                ...
                var hasRoute = routeDataService.TryGetRoute(new IntentRequest {Intent = new Intent {Name = "Test"}, Type = "IntentRequest"}, out var route);
            ...
            public void IntentRequestHasRoute_ReturnsRouteData()
            {
                ...
                routeDataService.TryGetRoute(new IntentRequest {Intent = new Intent {Name = "Test"}, Type = "IntentRequest"}, out var route);
            ...
            {
                var routes = new Dictionary<string, RouteData> {{"SomeIntent", new RouteData("TestController", "Index")}};
                var routeDataService = new RouteDataService(routes);
